...
打鍵カウンタ ([inf_daken_counter](https://github.com/dj-kata/inf_daken_counter_obsw)) の保存データ（v2 `alllog.pkl`, v3 `playlog.infdc`）を リザルト手帳 ([inf-notebook](https://github.com/kaktuswald/inf-notebook)) の JSON 形式に変換・移行するスクリプトです。
